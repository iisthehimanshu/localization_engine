...
class impericalLocalisation{
  Pt? estimateIntersectionCenter(
    ...
    if (probPt1 < probPt2) {
      return Pt(x: pt1[0].toDouble(), y: pt1[1].toDouble(), beacon: apibeaconmap[beaconKeys.first]!);
    } else {
      return Pt(x: pt2[0].toDouble(), y: pt2[1].toDouble(), beacon: apibeaconmap[beaconKeys.first]!);
    }
  }
